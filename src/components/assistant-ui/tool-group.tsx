...
function ToolGroupTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="relative inline-block text-start text-xs leading-none font-medium">
        <span>{label}</span>
        {active && (
      ...
      <ChevronDownIcon className={cn(
        "size-3 shrink-0 transition-transform duration-(--animation-duration) ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        "[&>*]:animate-in [&>*]:fade-in-0 [&>*]:slide-in-from-top-1 [&>*]:duration-(--animation-duration)",
      )}>
        {children}
      </div>
    </CollapsibleContent>
